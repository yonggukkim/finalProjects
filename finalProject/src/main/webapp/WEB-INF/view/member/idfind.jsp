          ...
          <div class="card-body">
            <h5 class="card-title text-center">ID 찾기</h5>
              ...
              <label for="inputMail">이메일</label>
                <input type="text" id="inputMail" class="form-control" placeholder="이메일을 입력 해주세요" required>
                
              </div>
              
                          <div class="form-label-group">
                          <label for="inputNumber">전화번호</label>
                <input type="text" id="inputNumber" class="form-control" placeholder="전화번호를 입력하세요" required>
                </div>
                </div>
              ...
              <button class="btn btn-lg btn-primary btn-block text-uppercase" >ID 찾기</button>
              </div>
				</div>	
			</div>
          </div>
